...
# Security & Vulnerability Disclosure — Anathema-Breaker
...
Sealed Rust typestate machine (RZ → EP → IZ topology). Reports concerning compile-time soundness, type-state bypasses, or unsafe transitions are in scope.
